#!/usr/bin/env python3
"""
Fetch coduri de reducere BestValue de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/bestvalue.eu
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/bestvalue.eu"
STORE_NAME = "BestValue"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru BestValue de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-bestvalue)"
    }
    try:
