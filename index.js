#!/usr/bin/env node
/**
 * Fetch coduri reducere BestValue de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/bestvalue.eu
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/bestvalue.eu";
const STORE_NAME  = "BestValue";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-bestvalue)" }
  });
